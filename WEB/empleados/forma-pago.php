...
<body class="socios-ini">
	...
	if (isset($_SESSION['fin'])) {
		...
		if (isset($_SESSION['inicio-emp']) && isset($_SESSION['lugar']) && isset($_SESSION['pelicula']) && isset($_SESSION['hora']) && isset($_SESSION['butacas'])) {
	?>
				...
				<?php 
					try{
						...
						foreach ($result as $forma) {
							if ($forma['cod_pago'] == 'PT-T') {
								$_SESSION['tipo_pago']='PT-T';
							}
						}
