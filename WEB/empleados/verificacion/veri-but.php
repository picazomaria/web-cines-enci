...
if (isset($_SESSION['inicio-emp']) && isset($_SESSION['lugar']) && isset($_SESSION['pelicula'])) {
			...
			if ($_POST['butaca']>=2 && $_POST['butaca']<=10) {
				...
				try{
					...
					$consulta='select count(*)
						...
						where h.cod_hora="'.$_SESSION['hora'].'" && p.nombre="'.$_SESSION['pelicula'].'" && b.fila='.$_POST['fila'].' && b.butaca='.$_POST['butaca'].'
						';
