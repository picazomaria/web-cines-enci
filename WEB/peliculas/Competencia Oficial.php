...
<html>
<head>
	<title>Competencia Oficial</title>
		...
		<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
			<?php
				try{
					...
					//cartelera-------------------------------------------------
					$consulta='SELECT * from peliculas where nombre="Competencia Oficial"';
					...
					foreach($result as $peli){
						...
						echo "<div class='row'>";
							...
							echo "<a href='".$peli['trailer']."'><img src='".$peli['imagen']."' style='margin-bottom:10%; margin-left:10%;height: 700px;
 								width: 500px;'></a></div>\n";
					...
					if (isset($_POST['lug-peli'])) {
					 	$consulta2="select * from horario where cod_hora like '".$_POST['lug-peli']."%' && cod_peli=7" ;
