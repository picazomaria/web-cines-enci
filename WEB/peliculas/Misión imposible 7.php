...
<html>
<head>
	<title>Misión imposible 7</title>
		...
		<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
			<?php
				try{
					...
					//cartelera-------------------------------------------------
					$consulta='SELECT * from peliculas where nombre="Misión imposible 7"';
					...
					if (isset($_POST['lug-peli'])) {
					 	$consulta2="select * from horario where cod_hora like '".$_POST['lug-peli']."%' && cod_peli=23" ;
