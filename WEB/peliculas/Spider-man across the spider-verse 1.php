...
<html>
<head>
	<title>Spider-man across the spider-verse 1</title>
		...
		<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
			<?php
				try{
					...
					//cartelera-------------------------------------------------
					$consulta='SELECT * from peliculas where nombre="Spider-man across the spider-verse 1"';
					...
					foreach($result as $peli){
						...
						echo "<div class='row'>";
							...
							echo "<a href='".$peli['trailer']."'><img src='".$peli['imagen']."' style='margin-bottom:10%; margin-left:10%;height: 650px;
 								width: 450px;'></a></div>\n";
					...
					if (isset($_POST['lug-peli'])) {
					 	$consulta2="select * from horario where cod_hora like '".$_POST['lug-peli']."%' && cod_peli=17" ;
