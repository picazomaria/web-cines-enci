...
<html>
<head>
	<title>El hombre del norte</title>
		...
		<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
			<?php
				try{
					...
					//cartelera-------------------------------------------------
					$consulta='SELECT * from peliculas where nombre="El hombre del norte"';
					...
					if (isset($_POST['lug-peli'])) {
					 	$consulta2="select * from horario where cod_hora like '".$_POST['lug-peli']."%' && cod_peli=25" ;
